...
const FUTURAMA_CHARACTERS = applyCharacterImageDefaults([
 ...
 // ========================================================
  ...
  // ========================================================
  // Mythic / Alternate Versions
  // ========================================================

  {
    id: "holophonor_fry",
    characterKey: "fry",
    variantKey: "holophonor",
    displayName: "Philip J. Fry",
    subtitle: "Holophonor Master",
    franchise: "Futurama",
    rarity: "mythic",
    prestige: 3,
    basePower: 14,
    ...
    tags: [CHARACTER_TAGS.HUMAN, CHARACTER_TAGS.MUSICIAN, CHARACTER_TAGS.BRAVE],
    flavor: "Somehow turns raw emotion into actual competence."
  },

  {
    ...
    traits: [TRAITS.HERO, TRAITS.MORAL_CODE],
    tags: [CHARACTER_TAGS.MUTANT, CHARACTER_TAGS.BRAVE, CHARACTER_TAGS.LEADER],
    flavor: "A rare moment of normalcy, with no reduction in effectiveness."
  },

  {
    ...
    preferredJob: JOB_TYPES.ENTERTAINMENT,
    traits: [TRAITS.ROGUE],
    tags: [CHARACTER_TAGS.ROBOT, CHARACTER_TAGS.PERFORMER, CHARACTER_TAGS.CHAOTIC],
    flavor: "A dramatic reinvention that changes nothing important."
  },

  {
    ...
    flavor: "Brings world-class focus to both limbo and paperwork."
  },

  {
    id: "successful_zoidberg",
    characterKey: "zoidberg",
    variantKey: "successful",
    displayName: "Dr. John A. Zoidberg",
    subtitle: "Successful",
    franchise: "Futurama",
    rarity: "mythic",
    prestige: 3,
    basePower: 13,
    preferredJob: JOB_TYPES.CARE,
    traits: [TRAITS.SUPPORT],
    tags: [CHARACTER_TAGS.ALIEN_UNKNOWN, CHARACTER_TAGS.DOCTOR, CHARACTER_TAGS.CONFIDENT],
    flavor: "A version of events that nobody else seems to remember."
  }
